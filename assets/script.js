...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Function to show the loading message and hide the mempool data table
  function showLoadingMessage() {
    const loadingMessageElement = document.getElementById('loading-message');
    const mempoolDataElement = document.getElementById('mempool-data');
    loadingMessageElement.style.display = 'block';
    mempoolDataElement.style.display = 'none';
  }

  // Function to hide the loading message and show the mempool data table
  function hideLoadingMessage() {
    const loadingMessageElement = document.getElementById('loading-message');
    const mempoolDataElement = document.getElementById('mempool-data');
    loadingMessageElement.style.display = 'none';
    mempoolDataElement.style.display = 'block';
  }
  ...
  // Update the mempool data every 10 seconds
  setInterval(fetchMempoolData, 10000);
});
